    ...
    setMenu() {
        ...
        for (let i = 0; i < this.navigation.length; i++) {
                ...
                if (this.navigation[i].children[j].children) {//alert('109')
                    for (let k = 0; k < this.navigation[i].children[j].children.length; k++) {
                        if (this.userRole != undefined) { //alert('111');
                            if (this.userRole.privileges.indexOf(this.navigation[i].children[j].children[k].privilege[0]) >= 0) {//alert('112');
                    ...
                    if (this.userRole != undefined) { //alert('124');
                        if (this.navigation[i].children[j].privilege) { //alert('125');
                            if (this.userRole.privileges.indexOf(this.navigation[i].children[j].privilege[0]) >= 0) { //alert('126');
                                submenues.push(this.navigation[i].children[j])
                            }
                        }
            ...
            if (submenues.length > 0) { //alert('134');
                ...
                // if()
                if (this.navigation[i].features && this.navigation[i].features.length > 0) { //sourav code
                    let index = this.currentUser.features.indexOf(this.navigation[i].features[0])
                    if (index != -1) {
        ...
        this.commonService.setItem('navigation', this.navigation);
    }
